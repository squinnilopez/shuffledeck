...
lib.ssMetadata = [
		{name:"project3shuffle_atlas_1", frames: [[0,0,1930,1088]]},
		{name:"project3shuffle_atlas_2", frames: [[0,0,1673,1032]]},
		{name:"project3shuffle_atlas_3", frames: [[1258,0,451,957],[1258,959,450,957],[0,1199,678,601],[0,0,1256,1197]]},
		{name:"project3shuffle_atlas_4", frames: [[1485,0,385,669],[1484,671,385,669],[656,386,826,384],[656,0,827,384],[0,1342,385,669],[387,1342,385,669],[774,1342,385,669],[1161,1342,385,669],[1548,1342,385,669],[0,516,385,669],[387,772,576,414],[0,0,654,514]]},
		{name:"project3shuffle_atlas_5", frames: [[1110,212,29,514],[0,1278,354,638],[703,295,299,210],[688,1506,181,83],[1027,1849,340,75],[871,1506,48,78],[761,750,54,669],[738,1676,48,78],[817,750,54,669],[857,1833,32,83],[955,212,47,76],[985,1178,53,669],[891,1833,32,83],[692,1824,47,76],[1040,1178,53,669],[741,1833,31,83],[622,750,62,76],[983,507,71,669],[774,1833,31,83],[891,212,62,76],[688,750,71,669],[1056,857,25,83],[769,1756,48,75],[873,750,54,669],[1056,942,25,83],[788,1676,48,75],[929,1178,54,669],[1110,728,36,83],[618,1119,48,90],[1004,212,50,240],[1056,212,52,643],[819,1753,36,83],[688,1676,48,90],[860,1591,50,240],[1095,857,52,643],[688,1768,79,54],[929,750,29,417],[891,0,230,210],[688,1421,231,83],[339,1921,345,76],[360,855,306,262],[1149,501,29,486],[0,0,358,637],[360,1119,256,83],[356,1840,334,79],[360,295,341,241],[0,639,358,637],[360,538,260,315],[1172,0,29,445],[688,1591,170,83],[686,1921,339,76],[1141,0,29,499],[622,538,359,210],[0,1918,337,78],[356,1278,330,560],[360,0,529,293]]}
];
...
(lib.CachedBmp_201 = function() {
	this.initialize(ss["project3shuffle_atlas_5"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_198 = function() {
	this.initialize(ss["project3shuffle_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_784 = function() {
	this.initialize(ss["project3shuffle_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.g2 = function() {
	this.initialize(ss["project3shuffle_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.ringslight = function() {
	this.initialize(ss["project3shuffle_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.sparklespink();
	this.instance.setTransform(-76.3,-72.7,0.1215,0.1215);
...
p.nominalBounds = new cjs.Rectangle(-76.3,-72.7,152.6,145.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-13.85,-167.2,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-12.15,-154.3,0.5,0.5);

	this.instance_2 = new lib.rudra();
	this.instance_2.setTransform(-13.4,11.75,0.2425,0.2414,0,-7.7988,-82.2731);

	this.instance_3 = new lib.CachedBmp_188();
	this.instance_3.setTransform(-13.75,-167.2,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-15.9,-153.5,0.5,0.5);

	this.instance_2 = new lib.Image_2();
	this.instance_2.setTransform(-9.25,-94.95,0.0546,0.2985);

	this.instance_3 = new lib.CachedBmp_792();
	this.instance_3.setTransform(-17.85,-167.2,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-13.7,-167.2,27,334.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#C1DCD9").ss(1,1,1).p("An5i5IPzAAQBkAAAABkIAACsQAABkhkAAIvzAAQhkAAAAhkIAAisQAAhkBkAAg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#C9E0DF").s().p("An6C6QhjAAgBhkIAAirQABhlBjABIP1AAQBjgBABBlIAACrQgBBlhjgBg");
...
p.nominalBounds = new cjs.Rectangle(-61.6,-19.6,123.30000000000001,39.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-11.95,-158.05,0.5,0.5);
	...
	this.instance_3.setTransform(-13,-162.35,0.5,0.5);

	this.instance_4 = new lib.back_0();
	this.instance_4.setTransform(-0.05,0,0.1409,1,0,0,0,96.2,167.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(-29.75,-63.05,0.1317,0.1317);

	this.instance_5 = new lib.Group_1_2();
	this.instance_5.setTransform(0.3,-1.1,0.5054,0.5054,0,0,0,57.8,122.5);
	this.instance_5.alpha = 0.5;
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(-56.8,-26.5,0.1375,0.1375);
...
p.nominalBounds = new cjs.Rectangle(-56.8,-26.5,113.69999999999999,52.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_6.setTransform(-0.2,-1.1,0.5054,0.5054,0,0,0,57.7,122.5);
...
p.nominalBounds = new cjs.Rectangle(-29.7,-63,59.3,126);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-19.7,-14.65,0.5,0.5);

	this.start = new lib.start();
	this.start.name = "start";
	this.start.shadow = new cjs.Shadow("#F175B3",3,3,4);
	new cjs.ButtonHelper(this.start, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.start},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-64.1,-22.1,136,52);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(249).to({_off:false},0).to({scaleX:13.8226,scaleY:13.8226,rotation:-720},748).to({scaleX:14.8115,scaleY:14.8115,rotation:-822.5783,alpha:0},100).wait(1));

	// Layer_1
	this.instance_1 = new lib.Tween18("synched",0);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:13.8226,scaleY:13.8226,rotation:-720},723).to({scaleX:18.7356,scaleY:18.7356,rotation:-1378.3044,alpha:0.4492},274).to({scaleX:20.5304,scaleY:20.5304,rotation:-1618.5612,alpha:0},100).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2130.2,-2128.3,4260.9,4256.4);
...
if (reversed == null) { reversed = false; }
	...
	this.eings2.setTransform(1,-0.25,0.2013,0.2013);
	this.eings2.alpha = 0.9414;
	this.eings2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.eings2).wait(100).to({_off:false},0).to({regY:-0.1,scaleX:0.6449,scaleY:0.6449,rotation:1440,y:-0.3,alpha:1,mode:"synched",startPosition:0},211).to({regX:0.1,scaleX:1.3173,scaleY:1.3173,rotation:2880,x:1.2,y:-0.4},200).wait(1).to({startPosition:0},0).to({scaleX:0.8153,scaleY:0.8153,rotation:4320,x:1.1,y:-0.35},200).wait(1).to({startPosition:0},0).to({scaleX:1.2037,scaleY:1.2037,rotation:5760,y:-0.3},199).to({scaleX:1.5055,scaleY:1.5055,rotation:7388.7657,x:1.25,y:-0.7,alpha:0.5898},163).to({regY:-0.3,scaleX:1.5463,scaleY:1.5463,rotation:7560,y:-0.75,alpha:0.0195},22).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-760.4,-761.6,1523.6,1522.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_y).to({regX:96.4,regY:167.2,scaleX:0.0259,scaleY:0.6811,x:49.75,y:109.25,alpha:1},5).wait(1).to({scaleX:0.6811,x:79.9,y:109.5},0).wait(16).to({regY:167.3,scaleX:0.0259,scaleY:0.59,x:51.45,y:94,alpha:0.7891},0).to({y:94.65,alpha:0.0195},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(14.3,-4.7,131.1,228.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_r).to({regX:96.6,regY:167.2,scaleX:0.03,scaleY:0.6811,x:65.65,y:113.9,alpha:1},5).wait(1).to({regX:96.4,scaleX:0.6811,x:57.65,y:119.6},0).wait(16).to({regX:98.3,scaleX:0.0259,x:64.85,y:113.9},0).wait(1).to({alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-8,0,131.1,233.6);
...
p.nominalBounds = new cjs.Rectangle(-16.7,-6.1,209.2,1158.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_h).to({regY:167.2,scaleX:0.0259,scaleY:0.6811,x:56.55,alpha:1},5).wait(1).to({scaleX:0.6811,x:95.65,y:121.5},0).wait(16).to({scaleX:0.0259,x:58.75,y:113.9},0).wait(1).to({regX:96.2,regY:167.3,scaleX:0.04,scaleY:0.04,x:65.65,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(30,0,131.3,235.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_f).to({regX:96.4,regY:167.2,scaleX:0.0259,scaleY:0.6811,x:58,y:117.2,alpha:1},5).to({regX:95.7,scaleX:0.6781,scaleY:0.6787,x:68.05,y:117,alpha:0.9492},1).wait(16).to({regX:98.2,scaleX:0.026,x:64.9,y:118.7},0).wait(1).to({y:119,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(3.2,3.3,130.5,229.29999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_c).to({regX:98.3,regY:167.2,scaleX:0.0259,scaleY:0.6811,x:60.9,y:117.6,alpha:1},5).to({regX:96.4,scaleX:0.6807,scaleY:0.6807,x:49.65,y:116.75},1).wait(16).to({regX:96.5,scaleX:0.0259,scaleY:0.6277,x:63.3,y:108.85,alpha:0.9219},0).wait(1).to({y:113.65,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-15.9,3,131,228.6);


// stage content:
(lib.project3shuffle = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		this.stop(); // stop the animation at frame 1
		
		// start button click handler
		this.startbutton.on('click', () => {
		    this.startbutton.visible = false; // hide the button
		    this.play(); // start the main animation
		});
	}
	...
	this.startbutton.setTransform(775,351.2);
	new cjs.ButtonHelper(this.startbutton, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.startbutton).wait(2259));
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_h).wait(214).to({_off:false},0).to({_off:true},2044).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.trigger_h).wait(214).to({_off:false},0).to({_off:true},2044).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).to({state:[{t:this.instance_6}]},107).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},29).to({state:[{t:this.instance_7}]},20).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},26).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},49).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},49).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},49).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},49).to({state:[{t:this.instance_7}]},28).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},26).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},49).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[{t:this.instance_7}]},49).to({state:[{t:this.instance_7}]},27).to({state:[{t:this.instance_7}]},16).to({state:[{t:this.instance_7}]},31).to({state:[{t:this.instance_7}]},26).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},48).to({state:[{t:this.instance_7}]},30).to({state:[]},20).wait(1));
	...
	this.sparkles.setTransform(750.35,355.55);
	this.sparkles._off = true;

	this.timeline.addTween(cjs.Tween.get(this.sparkles).wait(26).to({_off:false},0).to({_off:true},2232).wait(1));

	// gradient
	this.instance_16 = new lib.gradient();
	this.instance_16.setTransform(775,350);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(461).to({x:777,y:338},0).wait(1798));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(495.8,316.7,1279.6000000000001,482.7);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/project3shuffle_atlas_1.png", id:"project3shuffle_atlas_1"},
		{src:"images/project3shuffle_atlas_2.png", id:"project3shuffle_atlas_2"},
		{src:"images/project3shuffle_atlas_3.png", id:"project3shuffle_atlas_3"},
		{src:"images/project3shuffle_atlas_4.png", id:"project3shuffle_atlas_4"},
		{src:"images/project3shuffle_atlas_5.png", id:"project3shuffle_atlas_5"},
