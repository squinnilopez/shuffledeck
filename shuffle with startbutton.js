...
(lib.CachedBmp_67 = function() {
	this.initialize(ss["shuffle with startbutton_atlas_4"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_64 = function() {
	this.initialize(ss["shuffle with startbutton_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_29 = function() {
	this.initialize(ss["shuffle with startbutton_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.g2 = function() {
	this.initialize(ss["shuffle with startbutton_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_y).to({regX:96.4,regY:167.2,scaleX:0.0259,scaleY:0.6811,x:49.75,y:109.25,alpha:1},5).wait(1).to({scaleX:0.6811,x:65.65,y:109.5},0).wait(16).to({regY:167.3,scaleX:0.0259,scaleY:0.59,x:51.45,y:94,alpha:0.7891},0).to({y:94.65,alpha:0.0195},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-4.7,131.1,228.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_r).to({regX:96.6,regY:167.2,scaleX:0.03,scaleY:0.6811,x:65.65,y:113.9,alpha:1},5).wait(1).to({regX:96.4,scaleX:0.6811,y:119.6},0).wait(16).to({regX:98.3,scaleX:0.0259,x:64.85,y:113.9},0).wait(1).to({alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,131.1,233.6);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_h).to({regY:167.2,scaleX:0.0259,scaleY:0.6811,x:56.55,alpha:1},5).wait(1).to({scaleX:0.6811,x:65.65,y:121.5},0).wait(16).to({scaleX:0.0259,x:58.75,y:113.9},0).wait(1).to({regX:96.2,regY:167.3,scaleX:0.04,scaleY:0.04,x:65.65,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,131.3,235.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.popout_c).to({regX:98.3,regY:167.2,scaleX:0.0259,scaleY:0.6811,x:60.9,y:117.6,alpha:1},5).to({regX:96.4,scaleX:0.6807,scaleY:0.6807,x:65.65,y:116.75},1).wait(16).to({regX:96.5,scaleX:0.0259,scaleY:0.6277,x:63.3,y:108.85,alpha:0.9219},0).wait(1).to({y:113.65,alpha:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0.1,3,131,228.6);


// stage content:
(lib.shufflewithstartbutton = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_25.png?1759805127631", id:"CachedBmp_25"},
		{src:"images/shuffle with startbutton_atlas_1.png?1759805127357", id:"shuffle with startbutton_atlas_1"},
		{src:"images/shuffle with startbutton_atlas_2.png?1759805127357", id:"shuffle with startbutton_atlas_2"},
		{src:"images/shuffle with startbutton_atlas_3.png?1759805127357", id:"shuffle with startbutton_atlas_3"},
		{src:"images/shuffle with startbutton_atlas_4.png?1759805127358", id:"shuffle with startbutton_atlas_4"},
		{src:"sounds/ehved_orchestralloop.mp3?1759805127631", id:"ehved_orchestralloop"}
	],
	preloads: []
};
